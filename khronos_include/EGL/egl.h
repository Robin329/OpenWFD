...
#define EGL_MULTISAMPLE_RESOLVE_BOX_BIT  \
    0x0200 /* EGL_SURFACE_TYPE mask bits \
            */
#define EGL_SWAP_BEHAVIOR_PRESERVED_BIT  \
    0x0400 /* EGL_SURFACE_TYPE mask bits \
            */
 ...
 */
/*
EGLAPI EGLImageChannel eglCreateEGLImageChannel(const EGLint*
channel_attrib_list, const EGLint* producer_attrib_list, const EGLint*
consumer_attrib_list);

EGLAPI EGLBoolean eglIsEGLImageChannelReady(EGLImageChannel channel);
EGLAPI EGLBoolean eglDestroyEGLImageChannel(EGLImageChannel channel);
*/
#ifdef __cplusplus
}
#endif
